  ...
  >
    ...
    >
      <p style={{ margin: "0 0 12px" }}>
        Alibaug is rapidly growing, making it the perfect time
        to invest in homes that blend comfort, elegance, and
        modern living.
      </p>

      <p style={{ margin: "0 0 15px" }}>
        Just 45 mins via Ro-Ro and 15 mins by speed boat,
        Alibaug offers excellent connectivity with stunning
        coastal beauty.
      </p>
      ...
      >
        <li style={{ marginBottom: "10px", paddingLeft: "3px" }}>
          Smartly designed{" "}
          <strong style={{ color: "#430a09" }}>
            1 & 2 BHK homes
          </strong>{" "}
          planned for convenience, functionality, and everyday
          comfort.
        </li>

        <li style={{ marginBottom: "10px", paddingLeft: "3px" }}>
          Modern amenities that enhance your lifestyle and
          elevate everyday living.
        </li>

        <li style={{ marginBottom: "10px", paddingLeft: "3px" }}>
          Nature-filled surroundings with serene pathways and
          refreshing sea breeze.
        </li>

        <li style={{ marginBottom: "10px", paddingLeft: "3px" }}>
          Family-friendly spaces including safe and joyful play
          areas for children.
        </li>
...
>
  ...
  >
    ...
    >
      ...
      >
        S.K. PARADISE is a thoughtfully planned residential
        development in Alibaug, created for those who value
        comfort, elegance and a contemporary lifestyle
      ...
      >
        ...
        , modern amenities and thoughtfully planned spaces
        that make everyday living convenient and enjoyable.
      </p>
      ...
      >
        Located in the rapidly growing destination of Alibaug,
        S.K. PARADISE offers the opportunity to experience
        peaceful surroundings while staying well connected
        to Mumbai and the wider region.
      </p>
    </div>
...
>
  ...
  >
    ...
    <div>
      ...
      >
        Well connected to the key destinations of
        Alibaug, while remaining surrounded by the
        calm and beauty of its coastal landscape.
      </p>
    ...
    >
      ...
      <iframe
        title="Alibaug Location"
        src="https://www.google.com/maps?q=Alibag%2C%20Raigad%2C%20Maharashtra%2C%20India&output=embed"
        width="100%"
        height="100%"
        style={{
          border: "0",
      ...
      >
        ...
        <a
          href="https://www.google.com/maps/search/?api=1&query=Alibag%2C%20Raigad%2C%20Maharashtra%2C%20India"
          target="_blank"
