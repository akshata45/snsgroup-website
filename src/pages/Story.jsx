...
<section
  style={{
    padding: isMobile ? "80px 6%" : "130px 10%",
...
>
  ...
  >
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        <h4 style={{ color: gold, marginBottom: "5px" }}>
          1M+ Sq.Ft Delivered
        </h4>
    ...
    <div style={{ maxWidth: "560px" }}>
      ...
      >
        Building Spaces <br /> That Inspire Living
      </h1>
      ...
      >
        Founded in 2019, SNS GROUP was established with a vision to redefine
        construction through a balance of traditional expertise and modern
        execution.
      </p>
      ...
      >
        With over 1 million sq. ft. delivered, we specialize in residential,
        commercial, villa, and hospitality developments.
      </p>
      ...
      >
        We create long-term value, trust, and meaningful spaces that elevate
        lifestyles.
      </p>
    </div>
  </div>
...
<section
  style={{
    padding: isMobile ? "90px 6%" : "140px 10%",
    background: "#ffffff",
...
>
  ...
  >
    ...
    <div style={{ maxWidth: "560px" }}>
      ...
      >
        From Vision <br /> To Trusted Excellence
      </h2>
      ...
      >
        SNS GROUP was born from a strong foundation of industry knowledge and a
        passion for excellence. What started as a vision has evolved into a
        trusted name known for quality, transparency, and timely delivery.
      </p>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div
            style={{
              ...
              width: "1px",
              background:
                "linear-gradient(to bottom, transparent, #e2d8c3, transparent)",
          ...
          >
            {[
              [
                ...
                "We stay true to commitments and deliver before deadlines.",
              ],
              [
                FaShieldAlt,
                "THE GUARANTEE OF FAIR PRACTICES",
                "Transparency and ethical practices define our work.",
              ],
              [
                FaCogs,
                "THE STAMP OF UNSHAKEABLE INTEGRITY",
                "We uphold strong moral values in every project.",
              ],
              [
                FaRocket,
                "UNLIMITED POTENTIAL",
                "We empower customers with excellence and innovation.",
              ],
            ].map((item, i) => {
              const Icon = item[0];
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <div
                  style={{
                    order: window.innerWidth > 768 ? (isLeft ? 1 : 2) : 1,
                    display: "flex",
                    justifyContent: "center",
                  }}
                >
                ...
                <div
                  style={{
                    order: window.innerWidth > 768 ? (isLeft ? 2 : 1) : 2,
                    maxWidth: "520px",
                    margin: "0 auto",
