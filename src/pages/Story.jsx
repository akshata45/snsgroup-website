...
>
  <div style={{ maxWidth: "820px" }}>
    ...
    >
      Founded with a vision to redefine the construction landscape, SNS GROUP
      combines decades of inherited industry wisdom with modern, efficient
      practices. Since our establishment in 2019, we have been committed to
    ...
    >
      Today, we have successfully delivered over 1 million square feet of
      high-quality construction projects. From commercial hubs to bespoke
      residential developments, villas, and hospitality projects, our portfolio
      reflects a proven track record of meeting deadlines and exceeding
      standards.
    </p>
    ...
    >
      Every project we undertake is driven by precision, quality, and a strong
      commitment to client satisfaction shaping spaces that inspire future
  ...
  >
    ...
    >
      ...
      <div style={{ marginBottom: "35px" }}>
        <h3 style={{ color: gold, marginBottom: "10px", letterSpacing: "1px" }}>
          VALUES
        </h3>
      ...
      <div>
        ...
        <p style={{ color: "#444", lineHeight: "1.9", fontSize: "15px" }}>
          ...
          over individual recognition. The success we have achieved fuels our
          journey forward as we continue building a better future.
        </p>
      </div>
    </div>
  </div>
...
>
  ...
  {/* HEADER */}
  <div style={{ textAlign: "center", marginBottom: "45px" }}> {/* 🔥 reduced */}
    <p
      style={{
        color: "#353534",
        letterSpacing: "3px",
